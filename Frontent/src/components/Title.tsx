...
function Title({ setMessages }: Props) {
    ...
    return (
        <div className="flex justify-between items-center w-full p-4 bg-gray-900 text-white font-bold shadow">
            <div className="italic">Arti</div>
            <button onClick={resetConversation} className={"transition-all duration-300 text-blue-300 hover:text-green-500" + isReseting && "animate-pulse"} >
